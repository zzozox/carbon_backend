...
@ApiModel(value="CarbonTradeContractQueryParam对象", description="碳交易履约查询参数")
public class CarbonTradeContractQueryParam extends QueryParam {
    ...
    @ApiModelProperty(value = "交易截止日期-开始")
    private Date expirationDateStart;

    @ApiModelProperty(value = "交易截止日期-结束")
