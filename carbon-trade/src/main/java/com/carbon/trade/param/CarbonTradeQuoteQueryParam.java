...
@ApiModel(value="CarbonTradeQuoteQueryParam对象", description="碳交易供需行情查询参数")
public class CarbonTradeQuoteQueryParam extends QueryParam {
    private static final long serialVersionUID = 1L;

    @ApiModelProperty(value = "交易角色（字典：027）")
    private String tradeRole;

    @ApiModelProperty(value = "模糊搜索key")
